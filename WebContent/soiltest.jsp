...
<li class="active"><a class="link-1" href="soiltest.jsp">RENTING</a></li>
...
<h2 class="text-center soiltest_heading">RENT SERVICES</h2>
...
<h4>
Rent Request Fill Up Form</h4>
</div>

<div class="modal-body">
<form onsubmit="return valid()" action="SoilTest" method="post">

<div class="form-group">
<label for="farmer_date" style="color:black;">RENT DATE</label>
<%
 Date date=new Date();
 LocalDateTime now=LocalDateTime.now();
%>
<input type="text" class="form-control" id="farmer_date" name="soildate" readonly="readonly" value="<%= DateTimeFormatter.ofPattern("yyyy/MM/dd").format(now)%>"/>
</div>
...
<div class="form-group">
<label for="soiltype" style="color:black;">SELECT MACHINE NAME:</label>
<select class="form-control" id="soiltype" name="soiltype">
<option>Select</option>
<option>Hydroponic Air Pump</option>
<option>Mobile Vertical Growing Racks</option>
<option>Expanded Metal Benchtop Panels</option>
<option>EBB-N-FLOW Tray</option>
<option>Multi-Tier Growing Benches</option>
<option>NFT Kits</option>
<option>Hydroponic Water Pump</option>
<option>EBB-N-FLOW Benches</option>
<option>Rolling Greenhouse Benches</option>
</select>
</div>
...
<!-- *** COPYRIGHT ***-->
<div id="copyright" style="margin-top:7px;">
