...
<%} %>
<li class="active"><a class="link-1" href="demo1.jsp">MACHINE DEMO</a></li>
...
<h2 class="text-center soiltest_heading">MACHINE DEMO REQUEST</h2>
...
<h4>
Demo Request Fill Up Form</h4>
</div>

<div class="modal-body">
<form onsubmit="return valid()" action="success_demo1.jsp" method="post">
...
<div class="form-group">
<label for="soiltype" style="color:black;">SELECT MACHINE:</label>
