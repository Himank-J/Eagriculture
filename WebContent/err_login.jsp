...
{
%>
<li  class="active"><a class="link-1" href="login.jsp"><span class="glyphicon glyphicon-log-in"></span> LOGIN</a></li>
<%}
else
{
%>
...
<h3 style="color:red;text-align:center">Incorrect Username or Password</h3>
