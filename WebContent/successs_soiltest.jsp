...
<h3 style="text-align:center;color:red;">Your Request has been Successfully Recorded</h3><br />
...
<label for="farmer_date" style="color:black;">SOIL TEST DATE</label>
<%
 Date date=new Date();
...
<div class="form-group">
<label for="soiltype" style="color:black;">SELECT SOIL TYPE:</label>
...
<option>Saline and Alkaline Soils.</option>
